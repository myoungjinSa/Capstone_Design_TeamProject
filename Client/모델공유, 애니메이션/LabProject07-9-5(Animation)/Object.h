...
public:
	...
	void setTransforms(vector<CGameObject*> v) { v_Transforms = v; }
	vector<CGameObject*> v_Transforms;

	const vector<CGameObject*>& getStaticTransforms() const { return static_Transforms; }
	void setStaticTransforms(vector<CGameObject*>& v) { static_Transforms = v; }

	static vector<CGameObject*> static_Transforms;

	int getSknningBoneSize() const { return nSkinningBoneSize; }
	static int nSkinningBoneSize;
