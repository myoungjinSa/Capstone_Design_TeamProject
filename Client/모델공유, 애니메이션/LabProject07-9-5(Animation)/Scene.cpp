...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	//CGameObject *pAngrybotModel = CGameObject::LoadGeometryAndAnimationFromFile(
	//	pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/EvilbearA.bin", NULL, true);
	CGameObject *pAngrybotModel = CGameObject::LoadGeometryAndAnimationFromFile(
		pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Player.bin", NULL, true);
	v_Transforms = pAngrybotModel->getStaticTransforms();
	...
	m_ppGameObjects[2]->SetPosition(500.0f, m_pTerrain->GetHeight(500.0f, 680.0f), 680.0f);
