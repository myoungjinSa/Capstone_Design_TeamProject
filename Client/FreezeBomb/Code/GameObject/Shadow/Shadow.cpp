...
// 도망자의 그림자
void CShadow::RunAway_Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera* pCamera, int matID, bool HasHammer, bool HasGoldHammer, int nPipelineState)
{
	CGameObject::RunAway_Render(pd3dCommandList, pCamera, matID, HasHammer, HasGoldHammer, nPipelineState);
}
