...
//	m_ppObjects[0]->m_pAnimationController->SetTrackWeight(0, 0.8f);
	...
	m_ppObjects[2]->m_pAnimationController->SetTrackAnimationSet(0,  m_ppObjects[2]->m_pAnimationController->IDLE);
	...
	m_ppObjects[3]->m_pAnimationController->SetTrackAnimationSet(0, m_ppObjects[3]->m_pAnimationController->ATTACK);
	...
	m_ppObjects[4]->m_pAnimationController->SetTrackAnimationSet(0,  m_ppObjects[4]->m_pAnimationController->DIGGING);
...
void CSkinnedAnimationObjectShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera, int nPipelineState,float fTimeElapsed)
{
