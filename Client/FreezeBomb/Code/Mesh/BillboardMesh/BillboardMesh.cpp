...
CIlluminatedVertex::CIlluminatedVertex()
{
	m_xmf3Position = XMFLOAT3(0.0f, 0.0f, 0.0f);
	m_xmf3Normal = XMFLOAT3(0.0f, 0.0f, 0.0f);
}

CIlluminatedVertex::CIlluminatedVertex(float x, float y, float z, XMFLOAT3 xmf3Normal)
{
	m_xmf3Position = XMFLOAT3(x, y, z);
	m_xmf3Normal = xmf3Normal;
}

CIlluminatedVertex::CIlluminatedVertex(XMFLOAT3 xmf3Position, XMFLOAT3 xmf3Normal)
{
...
CMeshIlluminated::CMeshIlluminated(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
	: CMesh(pd3dDevice, pd3dCommandList)
{
}
...
void CCubeMeshIlluminated::ReleaseUploadBuffers()
{
...
void CCubeMeshIlluminated::Render(ID3D12GraphicsCommandList *pd3dCommandList, int nSubSet)
{
