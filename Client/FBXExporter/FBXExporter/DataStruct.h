...
public:
	...
	FbxLongLong							GetTimeStart() const { return m_tStart.GetFrameCount(FbxTime::eFrames100); }
	FbxLongLong							GetTimeEnd() const { return m_tEnd.GetFrameCount(FbxTime::eFrames100); }
