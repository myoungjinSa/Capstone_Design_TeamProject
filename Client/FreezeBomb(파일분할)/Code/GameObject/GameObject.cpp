...
//#define SIZE 128
		...
		strcpy_s(pstrFilePath + 15, SIZE - 15, (bDuplicated) ? (pstrTextureName+1) : pstrTextureName);
		strcpy_s(pstrFilePath + 15 + ((bDuplicated) ? (nStrLength - 1) : nStrLength), SIZE - 15 - ((bDuplicated) ? (nStrLength - 1) : nStrLength), ".dds");
