...
{
public:
	CMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, TCHAR *pstrFileName = NULL);
    virtual ~CMesh();
...
protected:
	...
	XMFLOAT3						*m_pxmf3BlendWeights = NULL;
	ID3D12Resource					*m_pd3dBlendWeightsBuffer = NULL;
	ID3D12Resource					*m_pd3dBlendWeightsUploadBuffer = NULL;

	UINT							*m_pxmf4BlendIndices = NULL;
	ID3D12Resource					*m_pd3dBlendIndicesBuffer = NULL;
	ID3D12Resource					*m_pd3dBlendIndicesUploadBuffer = NULL;
