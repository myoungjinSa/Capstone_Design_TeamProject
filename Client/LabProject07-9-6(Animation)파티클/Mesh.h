...
{
public:
	CTexturedRectMesh(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float width, float height, float fDepth, float fxPosition, float fyPosition, float fzPosition);
