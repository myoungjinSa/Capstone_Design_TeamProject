...
void CPlayer::OnPrepareRender()
{
	...
	//UpdateTransform(NULL);					//폭탄에 빌보드가 카메라를 바라보게 하기위해 Render보다 먼저 Animate가 호출되었다. 
												//UpdateTransform을 하게 되면 다시 빌보드가 회전되기 때문에 주석처리 하였다.
...
void CPlayer::Render(ID3D12GraphicsCommandList *pd3dCommandList, CCamera *pCamera)
{
	...
	{
		CGameObject::Render(pd3dCommandList, m_bIce, m_matID, pCamera);
	}
}
...
void CAirplanePlayer::Animate(float fTimeElapsed,CCamera *pCamera)
{
...
void CTerrainPlayer::Animate(float fTimeElapsed,CCamera *pCamera)
{
